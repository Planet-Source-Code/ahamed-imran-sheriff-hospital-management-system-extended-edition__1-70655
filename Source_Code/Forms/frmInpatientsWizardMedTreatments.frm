...
Begin VB.Form frmInpatientsWizardMedicals 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmInpatientsWizardMedTreatments.frx":0000
      Left            =   1800
      List            =   "frmInpatientsWizardMedTreatments.frx":0019
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmInpatientsWizardMedTreatments.frx":0072
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmInpatientsWizardMedTreatments.frx":0114
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -360
      Picture         =   "frmInpatientsWizardMedTreatments.frx":01B2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmInpatientsWizardMedicals"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsInpatientMaintenance.RecordCount > 0 Then
        ...
        With rsInpatientMaintenance
            ...
            frmMedicalTreatmentsMaintenance.txtPatientID.Text = .Fields(0).Value
            frmMedicalTreatmentsMaintenance.txtFirstName.Text = .Fields(1).Value
            frmMedicalTreatmentsMaintenance.txtSurname.Text = .Fields(2).Value
