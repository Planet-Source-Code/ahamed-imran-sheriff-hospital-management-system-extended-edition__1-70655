...
Begin VB.Form frmOutpatientsSearchAndFind 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmOutpatientsSearchAndFind.frx":0000
      Left            =   1800
      List            =   "frmOutpatientsSearchAndFind.frx":0019
      TabIndex        =   1
      Text            =   "-----------SELECT------------"
      Top             =   1320
      Width           =   2295
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmOutpatientsSearchAndFind.frx":0072
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmOutpatientsSearchAndFind.frx":0114
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -360
      Picture         =   "frmOutpatientsSearchAndFind.frx":01B2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmOutpatientsSearchAndFind"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsOutpatientsMaintenance.RecordCount > 0 Then
        ...
        With rsOutpatientsMaintenance
            ...
            frmAddServiceTreatmentsOut.txtPatientID.Text = .Fields(0).Value
            frmAddServiceTreatmentsOut.txtFirstName.Text = .Fields(1).Value
            frmAddServiceTreatmentsOut.txtSurname.Text = .Fields(2).Value
