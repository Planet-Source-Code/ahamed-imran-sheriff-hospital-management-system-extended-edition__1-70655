...
Begin VB.Form frmDepartmentSearchWizardWards 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmDepartmentSearchWizard.frx":0000
      Left            =   1800
      List            =   "frmDepartmentSearchWizard.frx":000A
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmDepartmentSearchWizard.frx":002E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmDepartmentSearchWizard.frx":00D0
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmDepartmentSearchWizard.frx":016E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmDepartmentSearchWizardWards"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsDepartmentsMaintenance.RecordCount > 0 Then
        ...
        With rsDepartmentsMaintenance
            ...
            frmWardsMaintenance.txtDepartmentID.Text = .Fields(0).Value
            frmWardsMaintenance.txtDepartmentName.Text = .Fields(1).Value
