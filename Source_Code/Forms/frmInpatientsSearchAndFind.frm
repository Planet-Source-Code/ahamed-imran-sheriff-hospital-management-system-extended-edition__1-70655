...
Begin VB.Form frmInpatientsSearchAndFind 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmInpatientsSearchAndFind.frx":0000
      Left            =   1800
      List            =   "frmInpatientsSearchAndFind.frx":0019
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmInpatientsSearchAndFind.frx":0072
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmInpatientsSearchAndFind.frx":0114
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -360
      Picture         =   "frmInpatientsSearchAndFind.frx":01B2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmInpatientsSearchAndFind"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsInpatientMaintenance.RecordCount > 0 Then
        ...
        With rsInpatientMaintenance
            ...
            frmAddServiceTreatmentsIn.txtPatientID.Text = .Fields(0).Value
            frmAddServiceTreatmentsIn.txtFirstName.Text = .Fields(1).Value
            frmAddServiceTreatmentsIn.txtSurname.Text = .Fields(2).Value
