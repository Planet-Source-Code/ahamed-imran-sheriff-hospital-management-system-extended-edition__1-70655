...
Begin VB.Form frmInpatientsWizardService 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmInpatientsWizardService.frx":0000
      Left            =   2280
      List            =   "frmInpatientsWizardService.frx":0019
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmInpatientsWizardService.frx":0072
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmInpatientsWizardService.frx":0114
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmInpatientsWizardService.frx":01B2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmInpatientsWizardService"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsInpatientMaintenance.RecordCount > 0 Then
        ...
        With rsInpatientMaintenance
            ...
            frmServiceTreatmentsMaintenance.txtPatientID.Text = .Fields(0).Value
            frmServiceTreatmentsMaintenance.txtFirstName.Text = .Fields(1).Value
            frmServiceTreatmentsMaintenance.txtSurname.Text = .Fields(2).Value
