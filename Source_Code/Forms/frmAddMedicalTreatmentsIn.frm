...
Begin VB.Form frmAddMedicalTreatmentsIn 
   ...
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "frmAddMedicalTreatmentsIn.frx":0000
   ScaleHeight     =   8910
   ScaleWidth      =   11805
   WindowState     =   2  'Maximized
   Begin VB.CommandButton cmdClose 
      DisabledPicture =   "frmAddMedicalTreatmentsIn.frx":1E353
      Height          =   855
      Left            =   6240
      Picture         =   "frmAddMedicalTreatmentsIn.frx":1E812
      Style           =   1  'Graphical
      TabIndex        =   15
      Top             =   7800
      Width           =   975
   ...
   Begin VB.CommandButton cmdDelete 
      DisabledPicture =   "frmAddMedicalTreatmentsIn.frx":21556
      Enabled         =   0   'False
      Height          =   855
      Left            =   5040
      Picture         =   "frmAddMedicalTreatmentsIn.frx":21A1F
      Style           =   1  'Graphical
      TabIndex        =   14
      Top             =   7800
      Width           =   975
   ...
   Begin VB.CommandButton cmdAdd 
      DisabledPicture =   "frmAddMedicalTreatmentsIn.frx":24763
      Height          =   855
      Left            =   3840
      Picture         =   "frmAddMedicalTreatmentsIn.frx":24B65
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   7800
      Width           =   975
   ...
   End
End
Attribute VB_Name = "frmAddMedicalTreatmentsIn"
...
Private Sub cmdAdd_Click()
    ...
    If textfieldsValidations = False Then
        ...
        If MsgBox("Are You Sure You Wish To Add This Record?", vbYesNo + vbQuestion, "Add This Record?") = vbYes Then
            ...
            Call InpatientsMedicalTreatments    'Calling the Inpatients Medical Treatments Function
            
            Set dgrdMedicalTreatmentsInfo.DataSource = rsInpatientsMedicalTreatments    'Setting the datasource for the datagrid
