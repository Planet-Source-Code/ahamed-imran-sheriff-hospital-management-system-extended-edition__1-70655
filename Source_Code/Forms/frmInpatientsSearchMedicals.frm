...
Begin VB.Form frmInpatientsSearchMedicals 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmInpatientsSearchMedicals.frx":0000
      Left            =   2160
      List            =   "frmInpatientsSearchMedicals.frx":0019
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -120
      Picture         =   "frmInpatientsSearchMedicals.frx":0072
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmInpatientsSearchMedicals.frx":0114
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmInpatientsSearchMedicals.frx":01B2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmInpatientsSearchMedicals"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsInpatientMaintenance.RecordCount > 0 Then
        ...
        With rsInpatientMaintenance
            ...
            frmAddMedicalTreatmentsIn.txtPatientID.Text = .Fields(0).Value
            frmAddMedicalTreatmentsIn.txtFirstName.Text = .Fields(1).Value
            frmAddMedicalTreatmentsIn.txtSurname.Text = .Fields(2).Value
