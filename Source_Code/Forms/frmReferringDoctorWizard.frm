...
Begin VB.Form frmReferringDoctorWizard 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Referring Doctor Search Wizard"
   ClientHeight    =   8850
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8835
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmReferringDoctorWizard.frx":0000
      Left            =   2160
      List            =   "frmReferringDoctorWizard.frx":0019
   ...
   Begin VB.CommandButton cmdApply 
      ...
      Width           =   1695
   End
   Begin MSDataGridLib.DataGrid dgrdReferringDoctorsInfoTable 
      Height          =   4815
      Left            =   240
      TabIndex        =   4
      Top             =   2280
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "Companies Information Table"
      ColumnCount     =   2
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmReferringDoctorWizard.frx":007F
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmReferringDoctorWizard.frx":0121
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmReferringDoctorWizard.frx":01BF
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmReferringDoctorWizard"
...
Private Sub Form_Load() 'Form Load Procedure
    ...
    Call ReferringDoctor_Selection    'Calling the ReferringDoctor_Selection Procedure to interact with the recordset
    
    Set dgrdReferringDoctorsInfoTable.DataSource = rsReferringDoctor  'Setting the DataSource of the DataGrid
...
Private Sub dgrdReferringDoctorsInfoTable_Click()    'This procedure is executed if the user clicks the DataGrid
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsReferringDoctor.RecordCount > 0 Then
    
        With rsReferringDoctor
        
            'Reset the textfields with the selected record
            frmAdmitPatient.txtReferredDoctorID.Text = .Fields(0).Value
            frmAdmitPatient.txtReferredDoctorName.Text = "Dr." & .Fields(2).Value
