...
Begin VB.Form frmCompanySearchWizard 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmCompanySearchWizard.frx":0000
      Left            =   1800
      List            =   "frmCompanySearchWizard.frx":000D
      Style           =   2  'Dropdown List
      TabIndex        =   0
      Top             =   1440
      Width           =   2295
   End
   Begin MSDataGridLib.DataGrid dgrdCompaniesInfoTable 
      Height          =   4815
      Left            =   240
      TabIndex        =   4
      Top             =   2280
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmCompanySearchWizard.frx":0042
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmCompanySearchWizard.frx":00E4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmCompanySearchWizard.frx":0182
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmCompanySearchWizard"
...
Private Sub Form_Load() 'Form Load Procedure
    ...
    Set dgrdCompaniesInfoTable.DataSource = rsCompaniesMaintenance  'Setting the DataSource of the DataGrid
...
Private Sub dgrdCompaniesInfoTable_Click()    'This procedure is executed if the user clicks the DataGrid
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsCompaniesMaintenance.RecordCount > 0 Then
    
        With rsCompaniesMaintenance
        
            'Reset the textfields with the selected record
            frmInpatientsMaintenance.txtCompanyID.Text = .Fields(0).Value
            frmInpatientsMaintenance.txtCompanyName.Text = .Fields(1).Value
