...
Begin VB.Form frmWardSearchWizard 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmWardSearchWizard.frx":0000
      Left            =   2040
      List            =   "frmWardSearchWizard.frx":000A
      TabIndex        =   3
      Text            =   "-----------SELECT------------"
      Top             =   1280
      Width           =   2295
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmWardSearchWizard.frx":0024
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmWardSearchWizard.frx":00C6
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmWardSearchWizard.frx":0164
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmWardSearchWizard"
...
Private Sub Form_Load() 'Form Load Procedure
    ...
    Call RelevantWard_Selection    'Calling the RelevantWard_Selection Procedure to interact with the recordset
    
    Set dgrdWardsInfoTable.DataSource = rsWardsSelection  'Setting the DataSource of the DataGrid
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsWardsSelection.RecordCount > 0 Then
        
        
        With rsWardsSelection
            
            'Reset the textfields with the selected record
            frmRoomsMaintenance.txtWardID.Text = .Fields(0).Value
            frmRoomsMaintenance.txtWardNumber.Text = .Fields(1).Value
