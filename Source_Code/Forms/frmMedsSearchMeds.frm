...
Begin VB.Form frmMedsSearchMeds 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Search Medicines Wizard"
   ClientHeight    =   8820
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8790
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmMedsSearchMeds.frx":0000
      Left            =   2160
      List            =   "frmMedsSearchMeds.frx":000D
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmMedsSearchMeds.frx":003A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmMedsSearchMeds.frx":00DC
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmMedsSearchMeds.frx":017A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmMedsSearchMeds"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsMedicinesMaintenance.RecordCount > 0 Then
        ...
        With rsMedicinesMaintenance
            ...
            frmMedicalTreatmentsOut.txtMedicineID.Text = .Fields(0).Value
            frmMedicalTreatmentsOut.txtMedicineName.Text = .Fields(1).Value
            frmMedicalTreatmentsOut.txtUnitPrice.Text = .Fields(3).Value
