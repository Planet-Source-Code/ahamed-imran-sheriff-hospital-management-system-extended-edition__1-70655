...
Begin VB.Form frmMedicinesWizardOut 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmMedicinesWizardOut.frx":0000
      Left            =   2160
      List            =   "frmMedicinesWizardOut.frx":000D
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmMedicinesWizardOut.frx":003A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmMedicinesWizardOut.frx":00DC
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmMedicinesWizardOut.frx":017A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmMedicinesWizardOut"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsMedicinesMaintenance.RecordCount > 0 Then
        ...
        With rsMedicinesMaintenance
            ...
            frmAddMedicalTreatmentsOut.txtMedicineID.Text = .Fields(0).Value
            frmAddMedicalTreatmentsOut.txtMedicineName.Text = .Fields(1).Value
            frmAddMedicalTreatmentsOut.txtUnitPrice.Text = .Fields(3).Value
