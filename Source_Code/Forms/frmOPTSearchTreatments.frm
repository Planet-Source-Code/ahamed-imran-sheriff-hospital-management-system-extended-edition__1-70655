...
Begin VB.Form frmOPTSearchTreatments 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmOPTSearchTreatments.frx":0000
      Left            =   1800
      List            =   "frmOPTSearchTreatments.frx":0019
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmOPTSearchTreatments.frx":0072
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmOPTSearchTreatments.frx":0114
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -360
      Picture         =   "frmOPTSearchTreatments.frx":01B2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmOPTSearchTreatments"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsOutpatientsMaintenance.RecordCount > 0 Then
        ...
        With rsOutpatientsMaintenance
            ...
            frmServiceTreatmentsOut.txtPatientID.Text = .Fields(0).Value
            frmServiceTreatmentsOut.txtFirstName.Text = .Fields(1).Value
            frmServiceTreatmentsOut.txtSurname.Text = .Fields(2).Value
