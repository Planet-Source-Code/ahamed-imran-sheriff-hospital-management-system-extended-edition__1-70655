...
Begin VB.Form frmDepartmentsSearchWizardAdmit 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Departments Search Wizard"
   ClientHeight    =   8850
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8895
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmDepartmentsSearchWizardAdmit.frx":0000
      Left            =   2160
      List            =   "frmDepartmentsSearchWizardAdmit.frx":000A
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmDepartmentsSearchWizardAdmit.frx":002E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmDepartmentsSearchWizardAdmit.frx":00D0
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmDepartmentsSearchWizardAdmit.frx":016E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmDepartmentsSearchWizardAdmit"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsDepartmentsMaintenance.RecordCount > 0 Then
        ...
        With rsDepartmentsMaintenance
            ...
            frmAdmitPatient.txtDepartmentID.Text = .Fields(0).Value
            frmAdmitPatient.txtDepartmentName.Text = .Fields(1).Value
