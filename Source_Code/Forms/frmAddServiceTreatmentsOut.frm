...
Begin VB.Form frmAddServiceTreatmentsOut 
   ...
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "frmAddServiceTreatmentsOut.frx":0000
   ScaleHeight     =   8910
   ScaleWidth      =   11820
   WindowState     =   2  'Maximized
   Begin VB.CommandButton cmdDelete 
      DisabledPicture =   "frmAddServiceTreatmentsOut.frx":1DEB8
      Enabled         =   0   'False
      Height          =   855
      Left            =   4920
      Picture         =   "frmAddServiceTreatmentsOut.frx":1E381
      Style           =   1  'Graphical
      TabIndex        =   12
      Top             =   7440
      Width           =   975
   ...
   Begin VB.CommandButton cmdAdd 
      DisabledPicture =   "frmAddServiceTreatmentsOut.frx":210C5
      Height          =   855
      Left            =   3720
      Picture         =   "frmAddServiceTreatmentsOut.frx":214C7
      Style           =   1  'Graphical
      TabIndex        =   11
      Top             =   7440
      Width           =   975
   ...
   Begin VB.CommandButton cmdClose 
      DisabledPicture =   "frmAddServiceTreatmentsOut.frx":2420B
      Height          =   855
      Left            =   6120
      Picture         =   "frmAddServiceTreatmentsOut.frx":246CA
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   7440
      Width           =   975
   ...
   End
End
Attribute VB_Name = "frmAddServiceTreatmentsOut"
...
Private Sub cmdAdd_Click()
    ...
    If textfieldsValidations = False Then
        ...
        If MsgBox("Are You Sure You Wish To Add This Record?", vbYesNo + vbQuestion, "Add This Record?") = vbYes Then
            ...
            Call Service_Treatments_Out    'Calling the Service_Treatments_Out Procedure to interact with the recordset
    
            'Generate Service Treatment ID By Utilizing the Service_Treatments_Out Table
            With rsServiceTreatmentsOut
                ...
                Else
                    ...
                    If iNumOfTreatments < 10 Then
                        strDisplay = "OST000" & iNumOfTreatments
                    ElseIf iNumOfTreatments < 100 Then
                        strDisplay = "OST00" & iNumOfTreatments
                    ElseIf iNumOfTreatments < 1000 Then
                        strDisplay = "OST0" & iNumOfTreatments
                    ElseIf iNumOfTreatments < 10000 Then
                        strDisplay = "OST" & iNumOfTreatments
                    End If
            ...
            Call OutpatientsServiceTreatments    'Calling the Outpatients Service Treatments Function
            
            Set dgrdServiceTreatmentsInfo.DataSource = rsOutpatientsServiceTreatments    'Setting the datasource for the datagrid
...
Private Sub cmdPatientSearchWizard_Click()  'On click of the Inpatients Search Wizard Button
    ...
    frmOutpatientsSearchAndFind.Show
