...
Begin VB.Form frmOutpatientsSearchMeds 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmOutpatientsSearchMeds.frx":0000
      Left            =   2160
      List            =   "frmOutpatientsSearchMeds.frx":0019
      TabIndex        =   2
      Text            =   "-----------SELECT------------"
      Top             =   1320
      Width           =   2295
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -120
      Picture         =   "frmOutpatientsSearchMeds.frx":0072
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmOutpatientsSearchMeds.frx":0114
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmOutpatientsSearchMeds.frx":01B2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmOutpatientsSearchMeds"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsOutpatientsMaintenance.RecordCount > 0 Then
        ...
        With rsOutpatientsMaintenance
            ...
            frmMedicalTreatmentsOut.txtPatientID.Text = .Fields(0).Value
            frmMedicalTreatmentsOut.txtFirstName.Text = .Fields(1).Value
            frmMedicalTreatmentsOut.txtSurname.Text = .Fields(2).Value
