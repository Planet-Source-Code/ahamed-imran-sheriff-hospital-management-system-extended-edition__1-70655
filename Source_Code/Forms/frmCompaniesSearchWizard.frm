...
Begin VB.Form frmCompaniesSearchWizard 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmCompaniesSearchWizard.frx":0000
      Left            =   2160
      List            =   "frmCompaniesSearchWizard.frx":000D
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmCompaniesSearchWizard.frx":0042
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmCompaniesSearchWizard.frx":00E4
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmCompaniesSearchWizard.frx":0182
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmCompaniesSearchWizard"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsCompaniesMaintenance.RecordCount > 0 Then
        ...
        With rsCompaniesMaintenance
            ...
            frmOutpatientsMaintenance.txtCompanyID.Text = .Fields(0).Value
            frmOutpatientsMaintenance.txtCompanyName.Text = .Fields(1).Value
