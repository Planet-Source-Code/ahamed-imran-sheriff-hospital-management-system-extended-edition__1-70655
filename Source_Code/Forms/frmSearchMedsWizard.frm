...
Begin VB.Form frmSearchMedsWizard 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmSearchMedsWizard.frx":0000
      Left            =   2160
      List            =   "frmSearchMedsWizard.frx":000D
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmSearchMedsWizard.frx":003A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmSearchMedsWizard.frx":00DC
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmSearchMedsWizard.frx":017A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmSearchMedsWizard"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsMedicinesMaintenance.RecordCount > 0 Then
        ...
        With rsMedicinesMaintenance
            ...
            frmAddMedicalTreatmentsIn.txtMedicineID.Text = .Fields(0).Value
            frmAddMedicalTreatmentsIn.txtMedicineName.Text = .Fields(1).Value
            frmAddMedicalTreatmentsIn.txtUnitPrice.Text = .Fields(3).Value
