...
Begin VB.Form frmInpatientSearchWizard 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmInpatientSearchWizard.frx":0000
      Left            =   2160
      List            =   "frmInpatientSearchWizard.frx":0019
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -120
      Picture         =   "frmInpatientSearchWizard.frx":0072
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmInpatientSearchWizard.frx":0114
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmInpatientSearchWizard.frx":01B2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmInpatientSearchWizard"
...
Private Sub cmdClose_Click()    'This procedure will close the Wizard
    ...
    'Calling the clearAllFields procedure in the Inpatients Maintenance Form
    frmInpatientsMaintenance.clearAllFields
    
    'Calling the Form_Load procedure in the Inpatients Maintenance Form
    frmInpatientsMaintenance.Form_Load
