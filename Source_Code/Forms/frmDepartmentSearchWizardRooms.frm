...
Begin VB.Form frmDepartmentSearchWizardRooms 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Department Search Wizard"
   ClientHeight    =   8850
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8835
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmDepartmentSearchWizardRooms.frx":0000
      Left            =   2160
      List            =   "frmDepartmentSearchWizardRooms.frx":000A
   ...
   Begin VB.CommandButton cmdApply 
      ...
      Width           =   1695
   End
   Begin MSDataGridLib.DataGrid dgrdDepartmentsInfoTable 
      Height          =   4815
      Left            =   240
      TabIndex        =   4
      Top             =   2280
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmDepartmentSearchWizardRooms.frx":002E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmDepartmentSearchWizardRooms.frx":00D0
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmDepartmentSearchWizardRooms.frx":016E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmDepartmentSearchWizardRooms"
...
Private Sub Form_Load() 'Form Load Procedure
    ...
    Set dgrdDepartmentsInfoTable.DataSource = rsDepartmentsMaintenance  'Setting the DataSource of the DataGrid
...
Private Sub dgrdDepartmentsInfoTable_Click()    'This procedure is executed if the user clicks the DataGrid
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsDepartmentsMaintenance.RecordCount > 0 Then
    
        With rsDepartmentsMaintenance
        
            'Reset the textfields with the selected record
            frmRoomsMaintenance.txtDepartmentID.Text = .Fields(0).Value
            frmRoomsMaintenance.txtDepartmentName.Text = .Fields(1).Value
            frmRoomsMaintenance.txtRoomCost = .Fields(2).Value
