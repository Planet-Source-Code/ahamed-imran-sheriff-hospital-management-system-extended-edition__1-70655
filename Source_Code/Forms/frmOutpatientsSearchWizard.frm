...
Begin VB.Form frmOutpatientsSearchWizard 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmOutpatientsSearchWizard.frx":0000
      Left            =   1800
      List            =   "frmOutpatientsSearchWizard.frx":0019
      TabIndex        =   1
      Text            =   "-----------SELECT------------"
      Top             =   1320
      Width           =   2295
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmOutpatientsSearchWizard.frx":0072
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -360
      Picture         =   "frmOutpatientsSearchWizard.frx":0114
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -360
      Picture         =   "frmOutpatientsSearchWizard.frx":01B2
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmOutpatientsSearchWizard"
...
Private Sub cmdClose_Click()    'This procedure will close the Wizard
    ...
    'Calling the clearAllFields procedure in the Outpatients Admission Form
    frmOutpatientsMaintenance.clearAllFields
    
    'Calling the Form_Load procedure in the Outpatients Admission Form
    frmOutpatientsMaintenance.Form_Load
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsOutpatientsMaintenance.RecordCount > 0 Then
        ...
        With rsOutpatientsMaintenance
            ...
            frmOutpatientsMaintenance.txtPatientID.Text = .Fields(0).Value
            frmOutpatientsMaintenance.txtFirstName.Text = .Fields(1).Value
            frmOutpatientsMaintenance.txtSurname.Text = .Fields(2).Value
            frmOutpatientsMaintenance.cboGender.Text = .Fields(3).Value
            frmOutpatientsMaintenance.dtpDateOfBirth.Value = .Fields(4).Value
            frmOutpatientsMaintenance.txtNICNumber.Text = .Fields(5).Value
            frmOutpatientsMaintenance.txtAddress.Text = .Fields(6).Value
            frmOutpatientsMaintenance.txtPhoneHome.Text = .Fields(7).Value
            frmOutpatientsMaintenance.txtPhoneMob.Text = .Fields(8).Value
            frmOutpatientsMaintenance.txtPatientOccupation.Text = .Fields(9).Value
            frmOutpatientsMaintenance.cboCivilStatus.Text = .Fields(10).Value
            frmOutpatientsMaintenance.cboAccountType.Text = .Fields(11).Value
            frmOutpatientsMaintenance.txtCompanyID.Text = .Fields(12).Value
            frmOutpatientsMaintenance.txtCompanyName.Text = .Fields(13).Value
            frmOutpatientsMaintenance.txtAssignedDoctorID.Text = .Fields(14).Value
