...
Begin VB.Form frmInpatientSearchDischarge 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmInpatientSearchDischarge.frx":0000
      Left            =   2160
      List            =   "frmInpatientSearchDischarge.frx":0016
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -120
      Picture         =   "frmInpatientSearchDischarge.frx":0063
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmInpatientSearchDischarge.frx":0105
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmInpatientSearchDischarge.frx":01A3
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmInpatientSearchDischarge"
...
Dim Flag As Boolean
Dim checkBillingFlag As Boolean    'This variable will check if the user has settled the bill in full or not
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    With rsInpatientBilling
        .MoveFirst
        Do While .EOF = False
            If .Fields(3).Value = rsInpatientMaintenance.Fields(0) And .Fields(12).Value = "PAID" Then
    ...
    If checkBillingFlag = False Then
        'Display Success Message
        MsgBox "You Cannot Discharge This Patient! He / She Has Not Settled All Payments!", vbCritical, "Error! Patient Cannot Be Discharged!"
        Exit Sub
    End If
        ...
        With rsInpatientMaintenance
            ...
            frmDischargeDetailsMaintenance.txtFirstName.Text = .Fields(1).Value
            frmDischargeDetailsMaintenance.txtSurname.Text = .Fields(2).Value
        ...
        With rsInpatientsAdmission
            ...
            While .EOF = False
                ...
                If .Fields(1).Value = rsInpatientMaintenance.Fields(0).Value Then
                    ...
                    frmDischargeDetailsMaintenance.txtAdmissionID.Text = .Fields(0).Value
                    frmDischargeDetailsMaintenance.txtPatientID.Text = .Fields(1).Value
                    frmDischargeDetailsMaintenance.txtAdmissionDate.Text = .Fields(3).Value
                    frmDischargeDetailsMaintenance.txtAdmissionTime.Text = .Fields(4).Value
