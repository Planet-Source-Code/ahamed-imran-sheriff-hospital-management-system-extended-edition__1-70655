...
Begin VB.Form frmDoctorSearchChanneling 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmDoctorSearchChanneling.frx":0000
      Left            =   2160
      List            =   "frmDoctorSearchChanneling.frx":001C
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   -120
      Picture         =   "frmDoctorSearchChanneling.frx":0093
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmDoctorSearchChanneling.frx":0135
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   -120
      Picture         =   "frmDoctorSearchChanneling.frx":01D3
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmDoctorSearchChanneling"
...
Private Sub Form_Load() 'Form Load Procedure
    ...
    Call AssignedDoctor_Selection    'Calling the AssignedDoctor_Selection Procedure to interact with the recordset
    
    Set dgrdDoctorsInfoTable.DataSource = rsAssignedDoctor  'Setting the DataSource of the DataGrid
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsAssignedDoctor.RecordCount > 0 Then
    
        With rsAssignedDoctor
        
            'Reset the textfields with the selected record
            frmChannelingAppointments.txtDoctorID.Text = .Fields(0).Value
            frmChannelingAppointments.txtSpecialization.Text = .Fields(10).Value
            frmChannelingAppointments.txtChannelingCharges.Text = .Fields(13).Value
            frmChannelingAppointments.txtAppointmentDuration.Text = .Fields(14).Value
                    
            frmChannelingAppointments.cmdCheckChannelingDays.Enabled = True 'Enabling the "Check Channeling Days" Button the Channeling Appointments form
            
            'Enabling the relevant textfields
            frmChannelingAppointments.txtDoctorID.Enabled = True
            frmChannelingAppointments.txtSpecialization.Enabled = True
            frmChannelingAppointments.txtChannelingCharges.Enabled = True
            frmChannelingAppointments.txtAppointmentDuration.Enabled = True
