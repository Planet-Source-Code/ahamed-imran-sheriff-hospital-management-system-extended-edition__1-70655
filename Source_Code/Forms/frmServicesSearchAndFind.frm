...
Begin VB.Form frmServicesSearchAndFind 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmServicesSearchAndFind.frx":0000
      Left            =   1680
      List            =   "frmServicesSearchAndFind.frx":000A
      TabIndex        =   0
      Text            =   "-----------SELECT------------"
      Top             =   1440
      Width           =   2415
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmServicesSearchAndFind.frx":0028
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmServicesSearchAndFind.frx":00CA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmServicesSearchAndFind.frx":0168
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmServicesSearchAndFind"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsServicesMaintenance.RecordCount > 0 Then
        ...
        With rsServicesMaintenance
            ...
            frmAddServiceTreatmentsIn.txtServiceID.Text = .Fields(0).Value
            frmAddServiceTreatmentsIn.txtServiceName.Text = .Fields(1).Value
            frmAddServiceTreatmentsIn.txtServiceCharge.Text = .Fields(2).Value
