...
Begin VB.Form frmServicesSearchNFind 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmServicesSearchNFind.frx":0000
      Left            =   2040
      List            =   "frmServicesSearchNFind.frx":000A
      TabIndex        =   3
      Text            =   "-----------SELECT------------"
      Top             =   1320
      Width           =   2415
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmServicesSearchNFind.frx":0028
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmServicesSearchNFind.frx":00CA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmServicesSearchNFind.frx":0168
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmServicesSearchNFind"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsServicesMaintenance.RecordCount > 0 Then
        ...
        With rsServicesMaintenance
            ...
            frmAddServiceTreatmentsOut.txtServiceID.Text = .Fields(0).Value
            frmAddServiceTreatmentsOut.txtServiceName.Text = .Fields(1).Value
            frmAddServiceTreatmentsOut.txtServiceCharge.Text = .Fields(2).Value
