...
Begin VB.Form frmAssignedDocWizard 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmAssignedDocWizard.frx":0000
      Left            =   2160
      List            =   "frmAssignedDocWizard.frx":0019
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmAssignedDocWizard.frx":007F
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmAssignedDocWizard.frx":0121
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmAssignedDocWizard.frx":01BF
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmAssignedDocWizard"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsAssignedDoctor.RecordCount > 0 Then
        ...
        With rsAssignedDoctor
            ...
            frmOutpatientsMaintenance.txtAssignedDoctorID.Text = .Fields(0).Value
