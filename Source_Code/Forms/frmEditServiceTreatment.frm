...
Begin VB.Form frmServiceTreatmentsMaintenance 
   Caption         =   "Service Treatments Maintenance Module"
   ClientHeight    =   8940
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11850
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "frmEditServiceTreatment.frx":0000
   ScaleHeight     =   8940
   ScaleWidth      =   11850
   WindowState     =   2  'Maximized
   Begin VB.CommandButton cmdUpdate 
      DisabledPicture =   "frmEditServiceTreatment.frx":1FEE6
      Height          =   855
      Left            =   7440
      Picture         =   "frmEditServiceTreatment.frx":203CC
      Style           =   1  'Graphical
      TabIndex        =   29
      Top             =   7440
      Width           =   975
   ...
   Begin VB.CommandButton cmdClose 
      DisabledPicture =   "frmEditServiceTreatment.frx":23110
      Height          =   855
      Left            =   8520
      Picture         =   "frmEditServiceTreatment.frx":235CF
      Style           =   1  'Graphical
      TabIndex        =   28
      Top             =   7440
      Width           =   975
   ...
   Begin VB.CommandButton cmdLast 
      DisabledPicture =   "frmEditServiceTreatment.frx":26313
      Height          =   750
      Left            =   3960
      Picture         =   "frmEditServiceTreatment.frx":266ED
      Style           =   1  'Graphical
      TabIndex        =   16
      Top             =   7500
      Width           =   890
   ...
   Begin VB.CommandButton cmdNext 
      DisabledPicture =   "frmEditServiceTreatment.frx":288A9
      Height          =   750
      Left            =   3000
      Picture         =   "frmEditServiceTreatment.frx":28C7F
      Style           =   1  'Graphical
      TabIndex        =   15
      Top             =   7500
      Width           =   890
   ...
   Begin VB.CommandButton cmdFirst 
      DisabledPicture =   "frmEditServiceTreatment.frx":2AE3B
      Height          =   750
      Left            =   1080
      Picture         =   "frmEditServiceTreatment.frx":2B217
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   7500
      Width           =   890
   ...
   Begin VB.CommandButton cmdPrevious 
      DisabledPicture =   "frmEditServiceTreatment.frx":2D3D3
      Height          =   750
      Left            =   2040
      Picture         =   "frmEditServiceTreatment.frx":2D7E8
      Style           =   1  'Graphical
      TabIndex        =   14
      Top             =   7500
      Width           =   890
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmEditServiceTreatment.frx":2F9A4
      Left            =   3360
      List            =   "frmEditServiceTreatment.frx":2F9B4
   ...
   End
End
Attribute VB_Name = "frmServiceTreatmentsMaintenance"
...
Private Sub cmdPatientSearchWizard_Click()
    ...
    frmInpatientsWizardService.Show
...
Public Sub Form_Load()
    ...
    Call Service_Treatments 'Calling the Service_Treatments Procedure
    ...
    Set dgrdServiceTreatments.DataSource = rsServiceTreatments   'Setting the DataSource of the DataGrid
...
Private Sub txtSearch_Change()
    ...
    Else
        ...
        Call Service_Treatments
        
        Set dgrdServiceTreatments.DataSource = rsServiceTreatments
