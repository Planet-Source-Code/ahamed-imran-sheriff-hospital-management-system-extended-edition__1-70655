...
Begin VB.Form frmAssignedDocSelectionWizard 
   ...
   Begin VB.ComboBox cboSearchType 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frmAssignedDocSelectionWizard.frx":0000
      Left            =   1800
      List            =   "frmAssignedDocSelectionWizard.frx":0019
   ...
   Begin MSDataGridLib.DataGrid dgrdDoctorsInfoTable 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "Doctors Information Table"
      ColumnCount     =   2
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   2
      Left            =   0
      Picture         =   "frmAssignedDocSelectionWizard.frx":007F
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   Begin VB.Image imgbg2 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmAssignedDocSelectionWizard.frx":0121
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   Begin VB.Image imgCenter 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frmAssignedDocSelectionWizard.frx":01BF
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9810
   End
   ...
   End
End
Attribute VB_Name = "frmAssignedDocSelectionWizard"
...
Private Sub cmdApply_Click()    'This code is executed when the user clicks the Apply Button
    ...
    If Flag = True And rsAssignedDoctor.RecordCount > 0 Then
        ...
        With rsAssignedDoctor
            ...
            frmAdmitPatient.txtAssignedDoctorID.Text = .Fields(0).Value
            frmAdmitPatient.txtAssignedDoctorName.Text = "Dr." & .Fields(2).Value
